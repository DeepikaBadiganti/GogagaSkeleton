setTimeout(() => {
  ...
  //Showing the content
  document.querySelectorAll('.navbar img, .navbar .nav-items').forEach(item => {
    item.style.display = 'block';
  });

  document.querySelector('.navtog-hide').style.display = 'block';
  document.querySelector('.banner-con-hide').style.display = 'block';
  document.querySelector('.des-sec-hide').style.display = 'block';
